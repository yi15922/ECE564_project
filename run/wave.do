...
add wave -noupdate -radix decimal /tb_top/dut/transposed_addr
...
add wave -noupdate -radix decimal /tb_top/dut/dut__tb__sram_scratchpad_read_address
...
add wave -noupdate /tb_top/dut/MAC_curr_row
add wave -noupdate /tb_top/dut/MAC_curr_col
...
add wave -noupdate -radix decimal /tb_top/dut/MAC/sram_input_read_address
add wave -noupdate -radix decimal /tb_top/dut/MAC/sram_weight_read_address
...
add wave -noupdate /tb_top/dut/MAC/calculation_done
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {3465 ns} 0}
...
update
WaveRestoreZoom {3416 ns} {3605 ns}
...
bookmark add wave bookmark7 {{3573 ns} {3762 ns}} 0
bookmark add wave bookmark8 {{3371 ns} {3560 ns}} 8
